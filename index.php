                ...
                <div class="col col-lg-5" style="margin-top: 10%;">
                    ...
                    <p class="lead text-center" style="color:white;">START BY FILLING UP THE FORM</p>
                        ...
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Sign Up" you agree to Kolors's <a
                ...
                <div class="pricing">
                    <ul class="list-group list-unstyled">
                        ...
                        <?php $feature = Features::find_by_feature_all($category_row->id); ?>
                            ...
                            <?php endforeach; ?>
                        <li class="list-group-item font-weight-bold">Price: Rs. <?= number_format($category_row->price); ?>
                         </li>
    ...
    <div class="row">
        <div class="col-12 col-md">
            <div class="text-center">
                <small class="d-block mb-3 text-muted">&copy; <?php echo date('Y')?> - Developed For Kolors Private Limited </small>
            </div>
        </div>
    </div>
</footer>
